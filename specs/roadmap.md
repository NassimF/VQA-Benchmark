...
> A human spot-check (~60–70 pairs, Cohen's κ) is recommended post-run to validate the
> curation gate (D8b). See `specs/2026-05-12-llm-review/requirements.md` for locked decisions.
